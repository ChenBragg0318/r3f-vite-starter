...
${menuOpened ? "w-80" : "w-0"}`}>
            <div className="flex-1 flex items-start justify-center flex-col gap-6 p-8">
                ...
                <MenuBotton label="Skills" onClick={()=>onSectionChange(1)}/>
                <MenuBotton label="Projects" onClick={()=>onSectionChange(2)}/>
                <MenuBotton label="Contact" onClick={()=>onSectionChange(3)}/>
            </div>
</div>
        </>
    )
